  ...
  <div id="header">
	...
	<div id="navigation">
		<ul>
			...
			<li><a href="<?php echo $rewrite->search; ?>">Szukaj</a></li>
		</ul>
	</div>
<div id="like">
<div class="fb-like" data-href="http://www.facebook.com/pages/Niesmutajpl/416415808443268" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false"></div>
</div>
<div id="dnavigation">
<ul>

			<?php $user->userTemplateInfo('
			<li>Cześć, Nieznajomy!</li>
			<li><a href="'.$rewrite->login.'">Zaloguj Się</a></li>
			<li>lub</li>
			<li><a href="'.$rewrite->register.'">Załóż Konto</a></li>',
									 
			'<li><a href="'.$rewrite->profile.'">Profil</a></li>
			<li><a href="'.$rewrite->inbox.'">Wiadomości <span class="sup">'.$inbox->get_new_pms($user->userInfo('id')).'</span></a></li>
